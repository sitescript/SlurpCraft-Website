...
import { FaHandHoldingHeart as QOL, FaGithub as Github } from "react-icons/fa"
        ...
        <div className="container flex h-16 items-center space-x-4 sm:justify-between sm:space-x-0">
          ...
          <div className="flex flex-1 items-center justify-end space-x-4">
            <nav className="flex items-center space-x-2">
              ...
              <Button asChild variant="outline" className="transition-transform hover:scale-105">
              <Link href="https://github.com/sitescript/SlurpCraft-Website" target="_blank">
                <Github className="mr-2 h-4 w-4 animate-pulse-subtle" />
                Github
                  </Link>
                </Button>
            </nav>
                  ...
                  <Tabs defaultValue="curseforge" className="w-full">
                    ...
                    <TabsContent value="curseforge" className="space-y-4">
                      <ol className="ml-6 list-decimal [&>li]:mt-2">
                        ...
                        <li>Click "Import" and select the zip file for "SlurpCraft"</li>
                      ...
                      <div className="mt-6 rounded-lg overflow-hidden shadow-lg">
                        <Image
                          src="https://cdn.nest.rip/uploads/04e06d84-ccf6-4ab4-8f55-1119d650fca1.png"
                          alt=""
                          width={800}
                          height={450}
                    ...
                    <TabsContent value="modrinth" className="space-y-4">
                      <ol className="ml-6 list-decimal [&>li]:mt-2">
                        <li>
                          Download and install the{" "}
                          <a href="https://modrinth.com/app" className="text-primary underline">
                            Modrinth App
                          </a>
                        </li>
                        <li>Open the app and click on "Library" in the sidebar</li>
                        <li>Click "Create Instance, From File" and "Import from File" Slurp Craft-2.2.0.mrpack</li>
                        <li>Once installed, click "Play" to launch the game</li>
                      </ol>
                      <p className="mt-4 text-sm text-muted-foreground">
                        Note: The Modrinth app will automatically handle all mod installations and updates for you.
                      </p>
                      <p className="mt-2 text-sm text-muted-foreground">
                        If you encounter any issues, check the{" "}
                        <a href="https://discord.gg/yzxyWhRSbC" className="text-primary underline">
                      ...
                      <div className="mt-6 grid grid-cols-2 gap-2 rounded-lg overflow-hidden shadow-lg">
                        <Image
                          src="https://cdn.nest.rip/uploads/20515e47-1ac7-4f23-bab2-58c071f492ea.png"
                          alt=""
                          width={400}
                          height={300}
                          className="w-full h-auto"
                        />
                        <Image
                          src="https://cdn.nest.rip/uploads/072efc21-858c-4d81-b7d5-b1ea02f1de10.png"
                          alt=""
                          width={400}
                          height={300}
                          className="w-full h-auto"
                    ...
                    <TabsContent value="manual" className="space-y-4">
                      <div className="space-y-6">
                        <div>
                          <h3 className="text-xl font-semibold mb-3">Forge</h3>
                          <ol className="ml-6 list-decimal [&>li]:mt-2">
                            <li>
                              Install{" "}
                              <a
                            ...
                            <li>
                              Download the SlurpCraft modpack ZIP file for Forge
                            </li>
                            <li>
                              Extract the ZIP file to your Minecraft mods folder (at %appdata%/.minecraft/mods)
                            </li>
                            <li>Launch Minecraft with the Forge profile</li>
                            <p className="mt-4 text-sm text-muted-foreground"> 
                            ⚠️ TexturePacks are also inside these HAVE to be moved to (%appdata%/.minecraft/texturepacks) </p>
                          </ol>
                        </div>

                        <div className="pt-4 border-t">
                          <h3 className="text-xl font-semibold mb-3">Prism Launcher</h3>
                          <ol className="ml-6 list-decimal [&>li]:mt-2">
                            <li>Click "Add Instance" and Click "Import"</li>
                            <li>Use the file/zip from CurseForge or Modrinth</li>
                            <li>Press "OK" and Prism will do it all for you</li>
                          </ol>
                          <p className="mt-4 text-sm text-muted-foreground">
                            Prism Launcher is an open-source Minecraft launcher that makes installing modpacks easy. You
                            can download it from{" "}
                            <a href="https://prismlauncher.org/" className="text-primary underline">
                              prismlauncher.org
                            </a>
                          </p>
                          ...
                          <div className="mt-6 rounded-lg overflow-hidden shadow-lg">
                            <Image
                              src="https://cdn.nest.rip/uploads/db2091d3-89e5-4a8d-933e-ef240fae3fe8.png"
                              alt=""
                              width={800}
                              height={450}
                              className="w-full h-auto"
                ...
                <CardContent>
                  <div className="space-y-4">
                    ...
                    <div className="rounded-lg border p-4 transition-all duration-300 hover:border-red-500/30 hover:shadow-md">
                      ...
                      <ul className="ml-6 list-disc [&>li]:mt-1">
                        <li>
                          This all depends on your severs CPU cores and RAM. When using free servers this becomes a
